            ...
            <div className={`subside-barmenu`}>
                ...
                <div className="sub-contact-wrapper d-grid">
                    <Link href="/" className="side-logo">
                        <img src="/assets/img/logo/logo.png" alt="img" className="img-fluid" />
                    </Link>
                    
                    <div className="sub-contact-left d-grid">
                        {/* Address Section */}
                        <div className="sub__contac-item mb-3 mb-md-4">
                            <div className="content">
                                <span className="address d-block mb-1 mb-md-2 fw-semibold">
                                    Address
                                </span>
                                <span className="textp fs-6 fs-md-5">
                        ...
                        <div className="sub__contac-item mb-3 mb-md-4">
                            <div className="content">
                                ...
                                <div className="d-flex flex-column flex-md-row flex-wrap gap-1 gap-md-2">
                                    <Link href="mailto:info@techasoft.com" className="textp fs-6 fs-md-5 text-decoration-none">
                                        info@techasoft.com
                                    </Link>
                                    <Link href="mailto:example021@gmail.com" className="textp fs-6 fs-md-5 text-decoration-none">
                        ...
                        <div className="sub__contac-item">
                            <div className="content">
                                <span className="address d-block mb-2 mb-md-3 fw-semibold">
                                    Call Now
                                </span>
                                <div className="phone-numbers d-grid gap-2">
                                    <Link href="tel:+16108800144" className="textp fs-6 fs-md-5 text-decoration-none d-flex align-items-center gap-2">
                                        <i className="fas fa-phone-alt fs-7"></i>
                                        <span>+1 610 880 0144</span>
                                    </Link>
                                    <Link href="tel:+971507557789" className="textp fs-6 fs-md-5 text-decoration-none d-flex align-items-center gap-2">
                                        <i className="fas fa-phone-alt fs-7"></i>
                                        <span>+971 507557789</span>
                                    </Link>
                                    <Link href="tel:+918884739988" className="textp fs-6 fs-md-5 text-decoration-none d-flex align-items-center gap-2">
                                        <i className="fas fa-phone-alt fs-7"></i>
                                        <span>+91 8884 739 988</span>
                                    </Link>
                                    <Link href="tel:+9961425747102" className="textp fs-6 fs-md-5 text-decoration-none d-flex align-items-center gap-2">
                                        <i className="fas fa-phone-alt fs-7"></i>
                                        <span>+996 1425 7471 0.2</span>
                                    </Link>
                                </div>
                            </div>
                        </div>
                    ...
                    {/* Social Media Icons */}
                    <ul className="common-social d-flex align-items-center gap-2 gap-md-3 mb-xxl-10 mb-xl-9 mb-8 mt-4 mt-md-5">
                        <li data-aos="zoom-in-right" data-aos-duration={1400}>
                            <Link href="/#" className="d-center social-icon" aria-label="Facebook">
                        ...
                        <li data-aos="zoom-in-right" data-aos-duration={1600}>
                            <Link href="/#" className="d-center social-icon" aria-label="Twitter">
                        ...
                        <li data-aos="zoom-in-right" data-aos-duration={1800}>
                            <Link href="/#" className="d-center social-icon" aria-label="LinkedIn">
                        ...
                        <li data-aos="zoom-in-right" data-aos-duration={1900}>
                            <Link href="/#" className="d-center social-icon" aria-label="YouTube">
                    ...
                    {/* Contact Button */}
                    <Link href="/contact" className="d-flex cmn-btn cmn-border justify-content-center fw-500 align-items-center gap-2 py-xl-3 py-2 px-2 px-md-4 rounded mt-4 mt-md-5">
                        <span className="icons">
                            <i className="fas fa-arrow-up white" />
                        </span>
                        <span className="get-text fs-6 fs-md-5">
                            Let's Talk
                        </span>
                    </Link>
                </div>
