...
export default function HEVNSolarSolution() {
                    ...
                    <div className="container">
                                ...
                                <div className="case-content-box bg1-clr py-xxl-10 py-xl-9 py-lg-8 py-6 px-xxl-10 px-xl-8 px-lg-6 px-5">
                                    ...
                                    <ul className="case-infobox mb-xxl-12 mb-xl-10 mb-lg-8 mb-7">
                                        <li className="d-flex align-items-center justify-content-between gap-2">
                                            ...
                                            <span className="white-clr">
                                               Solar Panel Installation<br/>& Services
                        ...
                        <div className="case-study-detials-inner">
                            <div className="interesting-fact">
                               ...
                               HEVN Solar Solution – Website Development
                                </h2>
    ...
    Website Development
                            ...
                            <div className="d-flex flex-md-nowrap flex-wrap justify-content-between gap-xxl-15 gap-xl-10 gap-lg-7 gap-sm-5 gap-3 ">
                                <p className="pra-clr " style={{color:'#004f39 !important '}}>
                                 HEVN Solar Solution is a Bangalore-based solar panel installation and service company focused on providing reliable and sustainable energy solutions. The objective of the project was to establish a strong digital presence that reflects professionalism, builds customer trust, and generates quality inquiries from residential and commercial clients. The website needed to clearly communicate services while positioning the brand as a credible solar solutions provider in Bangalore.
...
<h4 className="mb-xxl-7 mb-4 white-clr mt-2">
                              Our Development Approach
                                 ...
                                 <div className="d-flex flex-md-nowrap flex-wrap justify-content-between gap-xxl-15 gap-xl-10 gap-lg-7 gap-sm-5 gap-3 ">
                                <p className="pra-clr " style={{color:'#004f39 !important '}}>
                               We designed and developed a clean, modern, and conversion-focused website tailored to the solar industry. Complete website content was created from scratch, incorporating targeted local SEO keywords such as “Solar Panel Installation in Bangalore” and related service-based search terms. The structure was strategically organized to highlight services, expertise, and contact information in a clear and engaging manner. We implemented responsive design to ensure smooth performance across mobile and desktop devices. Basic on-page SEO optimization was carried out, including structured headings, optimized meta titles and descriptions, image optimization, and keyword-focused content. The entire project was executed and delivered within 5 days without compromising design quality or functionality.
