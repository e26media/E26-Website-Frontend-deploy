    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const formDataToSend = {
                ...
                message: formData.message || 'Interested in Data Science Course'
            }
                ...
                <div className="digital-solution mb-xxl-4 pb-lg-0 pb-15" style={{ marginTop: '130px' }}>
                    <div className="mycustom-marque">
                        <div className="scrolling-wrap">
                            <div className="comm">
                                <div className="cmn-textslide">Data Science Course</div>
                                <div><img src="/assets/img/E26media/elements/text-slide.png" alt="img" /></div>
                                <div className="cmn-textslide text-custom-storke">Data Science Course</div>
                                <div><img src="/assets/img/E26media/elements/text-slide.png" alt="img" /></div>
                            </div>
                            <div className="comm">
                                <div className="cmn-textslide">Data Science Course</div>
                    ...
                    <div className="container">
                        ...
                        <div className="service-details-header bb-border pb-xxl-9 pb-xl-7 pb-6">
                            ...
                            <h2 className="text-center mb-xxl-5 mb-xl-4 mb-lg-4 mb-3" style={{ color: '#004f39', fontSize: '1.5rem', fontWeight: '500' }}>
                                Master Machine Learning. Build Predictive Models. Become Job-Ready.
                            </h2>
                            ...
                            <div className="d-flex flex-wrap align-items-center justify-content-center gap-xxl-4 gap-xl-3 gap-2 mb-xxl-5 mb-xl-4 mb-lg-4 mb-3">
                                <span className="radius-btn cmn-border radius100 py-xxl-2 py-2 px-xxl-4 px-3" style={{ color: '#004f39', borderColor: '#004f39' }}>
                                    <i className="far fa-clock me-2"></i>Duration: 2 / 3 / 6 Months
                                </span>
                                <span className="radius-btn cmn-border radius100 py-xxl-2 py-2 px-xxl-4 px-3" style={{ color: '#004f39', borderColor: '#004f39' }}>
                                    <i className="far fa-calendar-alt me-2"></i>Mode: Live + Practical + Industry Project-Based
                                </span>
                                <span className="radius-btn cmn-border radius100 py-xxl-2 py-2 px-xxl-4 px-3" style={{ color: '#004f39', borderColor: '#004f39' }}>
                                    <i className="fas fa-signal me-2"></i>Level: Beginner to Advanced
                                </span>
                            </div>
                            ...
                            <div className="d-flex flex-wrap align-items-center justify-content-center gap-xxl-4 gap-xl-3 gap-3" data-aos="zoom-in-left" data-aos-duration={1800}>
                                ...
                                <Link href="/brochure/data-science.pdf" className="radius-btn cmn-border radius100 py-xxl-2 py-2 px-xxl-4 px-3" style={{ color: '#004f39', borderColor: '#004f39' }}>
                                    📄 Download Brochure
                                </Link>
                            </div>
                        ...
                        <div className="case-study-detials-inner mt-xxl-10 mt-xl-7 mt-6">
                            ...
                            <div className="d-flex flex-md-nowrap flex-wrap justify-content-between gap-xxl-15 gap-xl-10 gap-lg-7 gap-sm-5 gap-3 mb-xxl-9 mb-xl-8 mb-lg-7 mb-4">
                                <p className="challenge-pra1" style={{ color: 'black', fontSize: '1.1rem', lineHeight: '1.8' }}>
                                    The Data Science Training Program is designed for students and professionals who want to build strong foundations 
                                    in machine learning, statistics, and AI-powered analytics. If you are searching for a Data Science course in 
                                    Mangalore, Udupi, or Bangalore, this program provides hands-on learning using real datasets, industry case studies, 
                                    and portfolio-ready projects.
                                </p>
                                <p style={{ color: 'black', fontSize: '1.1rem', lineHeight: '1.8' }}>
                                    You will learn to analyze structured & unstructured data, build predictive ML models, perform feature engineering, 
                                    optimize model performance, and deploy data-driven solutions.
                                </p>
                            </div>
                            ...
                            <div className="finul-result">
                                    ...
                                    <div className="col-md-6 col-lg-4">
                                        <div className="p-4" style={{ background: '#f8f9fa', borderRadius: '12px', height: '100%' }}>
                                            <h4 style={{ color: '#004f39', marginBottom: '20px' }}>
                                                <i className="fab fa-python me-2"></i>Python for Data Science
                                            </h4>
                                            <ul className="list-unstyled">
                                                ...
                                                <li className="mb-2"><i className="fas fa-check-circle me-2" style={{ color: '#004f39' }}></i>Libraries for analytics</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div className="col-md-6 col-lg-4">
                                        <div className="p-4" style={{ background: '#f8f9fa', borderRadius: '12px', height: '100%' }}>
                                            <h4 style={{ color: '#004f39', marginBottom: '20px' }}>
                                                <i className="fas fa-chart-line me-2"></i>Data Preprocessing & EDA
                                            </h4>
                                            <ul className="list-unstyled">
                                                <li className="mb-2"><i className="fas fa-check-circle me-2" style={{ color: '#004f39' }}></i>Data cleaning</li>
                                                <li className="mb-2"><i className="fas fa-check-circle me-2" style={{ color: '#004f39' }}></i>Visualization</li>
                                                <li className="mb-2"><i className="fas fa-check-circle me-2" style={{ color: '#004f39' }}></i>Pattern identification</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div className="col-md-6 col-lg-4">
                                        <div className="p-4" style={{ background: '#f8f9fa', borderRadius: '12px', height: '100%' }}>
                                            <h4 style={{ color: '#004f39', marginBottom: '20px' }}>
                                                <i className="fas fa-calculator me-2"></i>Statistics & Probability
                                            </h4>
                                            <ul className="list-unstyled">
                                                <li className="mb-2"><i className="fas fa-check-circle me-2" style={{ color: '#004f39' }}></i>Hypothesis testing</li>
                                                <li className="mb-2"><i className="fas fa-check-circle me-2" style={{ color: '#004f39' }}></i>Distributions</li>
                                                <li className="mb-2"><i className="fas fa-check-circle me-2" style={{ color: '#004f39' }}></i>Statistical inference</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div className="col-md-6 col-lg-4">
                                        <div className="p-4" style={{ background: '#f8f9fa', borderRadius: '12px', height: '100%' }}>
                                            <h4 style={{ color: '#004f39', marginBottom: '20px' }}>
                                                <i className="fas fa-robot me-2"></i>Machine Learning
                                            </h4>
                                            <ul className="list-unstyled">
                                                <li className="mb-2"><i className="fas fa-check-circle me-2" style={{ color: '#004f39' }}></i>Regression models</li>
                                                <li className="mb-2"><i className="fas fa-check-circle me-2" style={{ color: '#004f39' }}></i>Classification algorithms</li>
                                                <li className="mb-2"><i className="fas fa-check-circle me-2" style={{ color: '#004f39' }}></i>Clustering techniques</li>
                                                <li className="mb-2"><i className="fas fa-check-circle me-2" style={{ color: '#004f39' }}></i>Model evaluation</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div className="col-md-6 col-lg-4">
                                        <div className="p-4" style={{ background: '#f8f9fa', borderRadius: '12px', height: '100%' }}>
                                            <h4 style={{ color: '#004f39', marginBottom: '20px' }}>
                                                <i className="fas fa-cloud-upload-alt me-2"></i>Model Deployment
                                            </h4>
                                            <ul className="list-unstyled">
                                                <li className="mb-2"><i className="fas fa-check-circle me-2" style={{ color: '#004f39' }}></i>Building ML pipelines</li>
                                                <li className="mb-2"><i className="fas fa-check-circle me-2" style={{ color: '#004f39' }}></i>Deployment basics</li>
                                                <li className="mb-2"><i className="fas fa-check-circle me-2" style={{ color: '#004f39' }}></i>Performance monitoring</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="p-4 mb-xxl-6 mb-xl-5 mb-4" style={{ background: '#f8f9fa', borderRadius: '12px' }}>
                                    <p style={{ fontSize: '1.1rem', color: '#333' }}>
                                        End-to-end Data Science project from dataset selection to deployment with performance reporting.
                                    </p>
                                </div>
                                ...
                                <div className="row mt-xxl-8 mt-xl-6 mt-5">
                                    <div className="col-md-6 mb-4">
                                        <div className="progress-item">
                                            <div className="d-flex justify-content-between mb-2">
                                                <span style={{ fontWeight: '600', color: '#004f39' }}>Python Mastery</span>
                                    ...
                                    <div className="col-md-6 mb-4">
                                        <div className="progress-item">
                                            ...
                                            <p style={{ fontSize: '12px', color: '#666', marginTop: '5px' }}>Regression, Classification, Clustering</p>
                                        </div>
                                    </div>
                                    <div className="col-md-6 mb-4">
                                        <div className="progress-item">
                                    ...
                                    <div className="col-md-6 mb-4">
                                        <div className="progress-item">
                                            ...
                                            <p style={{ fontSize: '12px', color: '#666', marginTop: '5px' }}>ML Pipelines, Deployment Basics</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="row g-4 mb-xxl-8 mb-xl-6 mb-5">
                                    <div className="col-md-3 col-6">
                                        <div className="text-center p-3">
                                            ...
                                            <h5 style={{ color: '#004f39', fontSize: '1rem' }}>Data Scientist</h5>
                                        </div>
                                    </div>
                                    <div className="col-md-3 col-6">
                                        <div className="text-center p-3">
                                            ...
                                            <h5 style={{ color: '#004f39', fontSize: '1rem' }}>ML Engineer</h5>
                                        </div>
                                    </div>
                                    <div className="col-md-3 col-6">
                                        <div className="text-center p-3">
