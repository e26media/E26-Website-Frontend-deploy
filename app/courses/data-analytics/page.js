    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const formDataToSend = {
                ...
                subject: 'Data Analytics Course',
                specificService: 'Course Application',
                message: formData.message || 'Interested in Data Analytics Course'
            }
                ...
                <div className="digital-solution mb-xxl-4 pb-lg-0 pb-15" style={{ marginTop: '130px' }}>
                    <div className="mycustom-marque">
                        <div className="scrolling-wrap">
                            <div className="comm">
                                <div className="cmn-textslide">Data Analytics Course</div>
                                <div><img src="/assets/img/E26media/elements/text-slide.png" alt="img" /></div>
                                <div className="cmn-textslide text-custom-storke">Data Analytics Course</div>
                                <div><img src="/assets/img/E26media/elements/text-slide.png" alt="img" /></div>
                            </div>
                            <div className="comm">
                                <div className="cmn-textslide">Data Analytics Course</div>
                    ...
                    <div className="container">
                        ...
                        <div className="service-details-header bb-border pb-xxl-9 pb-xl-7 pb-6">
                            ...
                            <div className="d-flex flex-wrap align-items-center justify-content-center gap-xxl-4 gap-xl-3 gap-2 mb-xxl-5 mb-xl-4 mb-lg-4 mb-3">
                                ...
                                <span className="radius-btn cmn-border radius100 py-xxl-2 py-2 px-xxl-4 px-3" style={{ color: '#004f39', borderColor: '#004f39' }}>
                                    <i className="far fa-calendar-alt me-2"></i>Mode: Practical + Case Study-Based
                                </span>
                            </div>
                            ...
                            <div className="d-flex flex-wrap align-items-center justify-content-center gap-xxl-4 gap-xl-3 gap-3" data-aos="zoom-in-left" data-aos-duration={1800}>
                                ...
                                <Link href="/brochure/data-analytics.pdf" className="radius-btn cmn-border radius100 py-xxl-2 py-2 px-xxl-4 px-3" style={{ color: '#004f39', borderColor: '#004f39' }}>
                                    📄 Download Brochure
                                </Link>
                            </div>
                        ...
                        <div className="case-study-detials-inner mt-xxl-10 mt-xl-7 mt-6">
                            ...
                            <div className="d-flex flex-md-nowrap flex-wrap justify-content-between gap-xxl-15 gap-xl-10 gap-lg-7 gap-sm-5 gap-3 mb-xxl-9 mb-xl-8 mb-lg-7 mb-4">
                                <p className="challenge-pra1" style={{ color: 'black', fontSize: '1.1rem', lineHeight: '1.8' }}>
                                    The Data Analytics Training Program focuses on analyzing data, building dashboards, and generating business insights.
                                    Perfect for students searching for a Data Analytics course in Karnataka.
                                </p>
                                <p style={{ color: 'black', fontSize: '1.1rem', lineHeight: '1.8' }}>
                                    You will learn to transform raw data into actionable insights using industry-standard tools and techniques. 
                                    Work on real-world case studies and build a portfolio that demonstrates your analytical capabilities.
                                </p>
                            </div>
                                    ...
                                    <div className="col-md-6">
                                        <div className="p-4" style={{ background: '#f8f9fa', borderRadius: '12px', height: '100%' }}>
                                            ...
                                            <ul className="list-unstyled">
                                                <li className="mb-2"><i className="fas fa-check-circle me-2" style={{ color: '#004f39' }}></i>Advanced formulas</li>
                                                <li className="mb-2"><i className="fas fa-check-circle me-2" style={{ color: '#004f39' }}></i>Pivot tables</li>
                                                <li className="mb-2"><i className="fas fa-check-circle me-2" style={{ color: '#004f39' }}></i>Dashboard creation</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div className="col-md-6">
                                        <div className="p-4" style={{ background: '#f8f9fa', borderRadius: '12px', height: '100%' }}>
                                            ...
                                            <ul className="list-unstyled">
                                                ...
                                                <li className="mb-2"><i className="fas fa-check-circle me-2" style={{ color: '#004f39' }}></i>Queries</li>
                                                <li className="mb-2"><i className="fas fa-check-circle me-2" style={{ color: '#004f39' }}></i>Data extraction</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="row g-4 mb-xxl-6 mb-xl-5 mb-4">
                                    <div className="col-md-6">
                                        <div className="p-4" style={{ background: '#f8f9fa', borderRadius: '12px', height: '100%' }}>
                                            ...
                                            <ul className="list-unstyled">
                                                <li className="mb-2"><i className="fas fa-check-circle me-2" style={{ color: '#004f39' }}></i>Data modeling</li>
                                                <li className="mb-2"><i className="fas fa-check-circle me-2" style={{ color: '#004f39' }}></i>Interactive dashboards</li>
                                                <li className="mb-2"><i className="fas fa-check-circle me-2" style={{ color: '#004f39' }}></i>KPI reporting</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div className="col-md-6">
                                        <div className="p-4" style={{ background: '#f8f9fa', borderRadius: '12px', height: '100%' }}>
                                            ...
                                            <ul className="list-unstyled">
                                                <li className="mb-2"><i className="fas fa-check-circle me-2" style={{ color: '#004f39' }}></i>Data storytelling</li>
                                                <li className="mb-2"><i className="fas fa-check-circle me-2" style={{ color: '#004f39' }}></i>Insight presentation</li>
                                                <li className="mb-2"><i className="fas fa-check-circle me-2" style={{ color: '#004f39' }}></i>Business case studies</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="col-md-6 mb-4">
                                        <div className="progress-item">
                                            <div className="d-flex justify-content-between mb-2">
                                                <span style={{ fontWeight: '600', color: '#004f39' }}>Excel Mastery</span>
                                            ...
                                            <p style={{ fontSize: '12px', color: '#666', marginTop: '5px' }}>Advanced Excel, Pivot Tables, Dashboards</p>
                                        </div>
                                    </div>
                                    <div className="col-md-6 mb-4">
                                        <div className="progress-item">
                                            ...
                                            <p style={{ fontSize: '12px', color: '#666', marginTop: '5px' }}>Complex Queries, Database Management</p>
                                        </div>
                                    </div>
                                    <div className="col-md-6 mb-4">
                                        <div className="progress-item">
                                            <div className="d-flex justify-content-between mb-2">
                                                <span style={{ fontWeight: '600', color: '#004f39' }}>Power BI & Visualization</span>
                                            ...
                                            <p style={{ fontSize: '12px', color: '#666', marginTop: '5px' }}>Interactive Dashboards, KPI Reporting</p>
                                        </div>
                                    </div>
                                    <div className="col-md-6 mb-4">
                                        <div className="progress-item">
                                            <div className="d-flex justify-content-between mb-2">
                                                <span style={{ fontWeight: '600', color: '#004f39' }}>Business Analytics</span>
                                            ...
                                            <p style={{ fontSize: '12px', color: '#666', marginTop: '5px' }}>Data Storytelling, Business Case Studies</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="row g-4 mb-xxl-8 mb-xl-6 mb-5">
                                    ...
                                    <div className="col-md-3 col-6">
                                        <div className="text-center p-3">
                                            ...
                                            <h5 style={{ color: '#004f39', fontSize: '1rem' }}>Reporting Analyst</h5>
                                        </div>
                                    </div>
                                    <div className="col-md-3 col-6">
                                        <div className="text-center p-3">
