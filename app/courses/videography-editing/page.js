...
export default function VideographyEditingCourse() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const formDataToSend = {
                ...
                subject: 'Videography & Editing Course',
                specificService: 'Course Application',
                message: formData.message || 'Interested in Videography & Editing Course'
            }
                ...
                <div className="digital-solution mb-xxl-4 pb-lg-0 pb-15" style={{ marginTop: '130px' }}>
                    <div className="mycustom-marque">
                        <div className="scrolling-wrap">
                            <div className="comm">
                                <div className="cmn-textslide">Videography & Editing Course</div>
                                <div><img src="/assets/img/E26media/elements/text-slide.png" alt="img" /></div>
                                <div className="cmn-textslide text-custom-storke">Videography & Editing Course</div>
                                <div><img src="/assets/img/E26media/elements/text-slide.png" alt="img" /></div>
                            </div>
                            <div className="comm">
                                <div className="cmn-textslide">Videography & Editing Course</div>
                        ...
                        <div className="service-details-header bb-border pb-xxl-9 pb-xl-7 pb-6">
                            <div className="d-flex justify-content-center mb-xxl-12 mb-xl-9 mb-sm-6 mb-5" data-aos="zoom-in" data-aos-duration={1500}>
                                <div style={{ width: '50%', maxWidth: '600px', margin: '0 auto' }}>
                                    <img 
                                        ...
                                        alt="Videography & Editing Course" 
                                        className="w-100" 
                            ...
                            <div className="d-flex flex-wrap align-items-center justify-content-center gap-xxl-4 gap-xl-3 gap-2 mb-xxl-5 mb-xl-4 mb-lg-4 mb-3">
                                <span className="radius-btn cmn-border radius100 py-xxl-2 py-2 px-xxl-4 px-3" style={{ color: '#004f39', borderColor: '#004f39' }}>
                                    <i className="far fa-clock me-2"></i>Duration: 2–4 Months
                                </span>
                                <span className="radius-btn cmn-border radius100 py-xxl-2 py-2 px-xxl-4 px-3" style={{ color: '#004f39', borderColor: '#004f39' }}>
                            ...
                            <div className="d-flex flex-wrap align-items-center justify-content-center gap-xxl-4 gap-xl-3 gap-3" data-aos="zoom-in-left" data-aos-duration={1800}>
                                ...
                                <Link href="/brochure/videography-editing.pdf" className="radius-btn cmn-border radius100 py-xxl-2 py-2 px-xxl-4 px-3" style={{ color: '#004f39', borderColor: '#004f39' }}>
                                    📄 Download Brochure
                                </Link>
                            </div>
                        ...
                        <div className="case-study-detials-inner mt-xxl-10 mt-xl-7 mt-6">
                            ...
                            <div className="d-flex flex-md-nowrap flex-wrap justify-content-between gap-xxl-15 gap-xl-10 gap-lg-7 gap-sm-5 gap-3 mb-xxl-9 mb-xl-8 mb-lg-7 mb-4">
                                <p className="challenge-pra1" style={{ color: 'black', fontSize: '1.1rem', lineHeight: '1.8' }}>
                                    This program teaches professional videography, editing, and marketing-focused storytelling.
                                    Perfect for students searching for a Video Editing course in Mangalore.
                                </p>
                                <p style={{ color: 'black', fontSize: '1.1rem', lineHeight: '1.8' }}>
                                    You will learn to create stunning videos for social media, brands, and businesses through 
                                    hands-on projects and industry-standard techniques.
                                </p>
                            </div>
                                    ...
                                    <div className="col-md-6">
                                        <div className="p-4" style={{ background: '#f8f9fa', borderRadius: '12px', height: '100%' }}>
                                            ...
                                            <ul className="list-unstyled">
                                                ...
                                                <li className="mb-2"><i className="fas fa-check-circle me-2" style={{ color: '#004f39' }}></i>Creative storytelling</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div className="col-md-6">
                                        <div className="p-4" style={{ background: '#f8f9fa', borderRadius: '12px', height: '100%' }}>
                                            ...
                                            <ul className="list-unstyled">
                                                <li className="mb-2"><i className="fas fa-check-circle me-2" style={{ color: '#004f39' }}></i>Camera handling</li>
                                                <li className="mb-2"><i className="fas fa-check-circle me-2" style={{ color: '#004f39' }}></i>Lighting basics</li>
                                                <li className="mb-2"><i className="fas fa-check-circle me-2" style={{ color: '#004f39' }}></i>Composition</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="row g-4 mb-xxl-6 mb-xl-5 mb-4">
                                    <div className="col-md-6">
                                        <div className="p-4" style={{ background: '#f8f9fa', borderRadius: '12px', height: '100%' }}>
                                            ...
                                            <ul className="list-unstyled">
                                                <li className="mb-2"><i className="fas fa-check-circle me-2" style={{ color: '#004f39' }}></i>Cutting & transitions</li>
                                                <li className="mb-2"><i className="fas fa-check-circle me-2" style={{ color: '#004f39' }}></i>Audio sync</li>
                                                <li className="mb-2"><i className="fas fa-check-circle me-2" style={{ color: '#004f39' }}></i>Color correction</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div className="col-md-6">
                                        <div className="p-4" style={{ background: '#f8f9fa', borderRadius: '12px', height: '100%' }}>
                                            ...
                                            <ul className="list-unstyled">
                                                <li className="mb-2"><i className="fas fa-check-circle me-2" style={{ color: '#004f39' }}></i>Reels</li>
                                ...
                                <div className="row mt-xxl-8 mt-xl-6 mt-5">
                                    <div className="col-md-6 mb-4">
                                        <div className="progress-item">
                                            ...
                                            <p style={{ fontSize: '12px', color: '#666', marginTop: '5px' }}>Camera Handling, Lighting, Composition</p>
                                        </div>
                                    </div>
                                    <div className="col-md-6 mb-4">
                                        <div className="progress-item">
                                            ...
                                            <p style={{ fontSize: '12px', color: '#666', marginTop: '5px' }}>Cutting, Transitions, Audio Sync</p>
                                        </div>
                                    </div>
                                    <div className="col-md-6 mb-4">
                                        <div className="progress-item">
                                            <div className="d-flex justify-content-between mb-2">
                                                <span style={{ fontWeight: '600', color: '#004f39' }}>Color Grading</span>
                                            ...
                                            <p style={{ fontSize: '12px', color: '#666', marginTop: '5px' }}>Color Correction, Grading, Visual Enhancement</p>
                                        </div>
                                    </div>
                                    <div className="col-md-6 mb-4">
                                        <div className="progress-item">
                                ...
                                <div className="row g-4 mb-xxl-8 mb-xl-6 mb-5">
                                    ...
                                    <div className="col-md-3 col-6">
                                        <div className="text-center p-3">
                                            ...
                                            <h5 style={{ color: '#004f39', fontSize: '1rem' }}>Video Production Associate</h5>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div className="col-lg-8">
                                            <div className="form-container" style={{
                                                ...
                                                <h3 style={{ color: '#004f39', marginBottom: '10px', textAlign: 'center' }}>
                                                    Apply for Videography & Editing Course
                                                </h3>
