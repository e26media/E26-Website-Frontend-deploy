                        ...
                        <div className="case-study-detials-inner">
                            <div className="interesting-fact">
                                <h2 className="white-clr mb-6" >
                                  Tawakkal Muslim – Islamic App & Meta Ads
                                </h2>
     ...
     Meta Ads
                            ...
                            <div className="d-flex flex-md-nowrap flex-wrap justify-content-between gap-xxl-15 gap-xl-10 gap-lg-7 gap-sm-5 gap-3 ">
                                <p className="pra-clr " style={{color:'#004f39 !important '}}>
                                   Tawakkal Muslim is an all-in-one Islamic lifestyle application developed to support users in maintaining their daily spiritual practices through features such as Prayer Times, Quran access, Duas, Qibla direction, and reminders. The goal of the project was to build a reliable, spiritually aligned, and easy-to-use mobile platform that simplifies everyday worship while ensuring smooth performance across Android devices. Over a 5-month development cycle, we focused on creating an application that balances functionality with simplicity.
...
<h4 className="mb-xxl-7 mb-4 white-clr mt-2">
                              Our Development Approach
                                 ...
                                 <div className="d-flex flex-md-nowrap flex-wrap justify-content-between gap-xxl-15 gap-xl-10 gap-lg-7 gap-sm-5 gap-3 ">
                                <p className="pra-clr " style={{color:'#004f39 !important '}}>
                                  The app was designed with a clean and minimal Islamic-themed interface to ensure a distraction-free user experience. Accurate prayer time integration was implemented with notification support to maintain consistency and reliability. The Qibla direction feature was carefully developed to provide precision across different devices. Quran and Dua modules were structured for smooth browsing and readability, ensuring users can access religious content effortlessly. Performance optimization was a key priority, resulting in a lightweight and fast-loading application. We also managed the complete Play Store deployment process, ensuring compliance and smooth publishing.
