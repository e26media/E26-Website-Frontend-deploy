...
export default function Chetans() {
                        ...
                        <div className="case-study-detials-inner">
                            <div className="interesting-fact">
                                <h2 className="white-clr mb-6" >
                                  Chetan’s Beauty Parlour – Meta Ads Campaign
                                </h2>
    ...
    Meta Ads Campaign
                            ...
                            <div className="d-flex flex-md-nowrap flex-wrap justify-content-between gap-xxl-15 gap-xl-10 gap-lg-7 gap-sm-5 gap-3 ">
                                <p className="pra-clr " style={{color:'#004f39 !important '}}>
                                   Chetan's Beauty Parlour aimed to increase appointment bookings and attract new customers within its local service area. The focus was on generating quality leads that convert into actual walk-ins and service bookings.
...
<h4 className="mb-xxl-7 mb-4 white-clr mt-2">
                             Our Strategy & Execution
                                 ...
                                 <div className="d-flex flex-md-nowrap flex-wrap justify-content-between gap-xxl-15 gap-xl-10 gap-lg-7 gap-sm-5 gap-3 ">
                                <p className="pra-clr " style={{color:'#004f39 !important '}}>
                                  We created localized Meta advertising campaigns targeting audiences based on demographics, beauty interests, and service preferences. Ad creatives emphasized service quality, offers, and transformation results. Lead generation forms were optimized to reduce friction and encourage direct inquiries.


                                </p>
                                <p  style={{color:'#004f39 !important '}}>
                                   Beyond just running ads, we handled campaign monitoring, creative optimization, audience testing, and conversion-focused adjustments from our side to ensure better results.
