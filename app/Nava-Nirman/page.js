...
export default function NavaNirman() {
                                ...
                                <div className="case-content-box bg1-clr py-xxl-10 py-xl-9 py-lg-8 py-6 px-xxl-10 px-xl-8 px-lg-6 px-5">
                                    ...
                                    <ul className="case-infobox mb-xxl-12 mb-xl-10 mb-lg-8 mb-7">
                                        ...
                                        <li className="d-flex align-items-center justify-content-between gap-2">
                                            ...
                                            <span className="white-clr">
                                                Branding & Large-Scale <br/>Flex Design
                        ...
                        <div className="case-study-detials-inner">
                            <div className="interesting-fact">
                                <h2 className="white-clr mb-6" >
                                 Nava Nirman – Billboard Branding
                                </h2>
  ...
  Branding 
                            ...
                            <div className="d-flex flex-md-nowrap flex-wrap justify-content-between gap-xxl-15 gap-xl-10 gap-lg-7 gap-sm-5 gap-3 ">
                                <p className="pra-clr " style={{color:'#004f39 !important '}}>
                                  Nava Nirman is a construction and real estate brand aiming to establish a strong and premium market presence. The objective of this project was to create a bold outdoor branding solution that enhances visibility, builds credibility, and positions the brand as a trusted developer in the region. The requirement was to design a large-format flex billboard with an internal LED lighting setup that remains visually impactful during both daytime and nighttime.
...
<h4 className="mb-xxl-7 mb-4 white-clr mt-2">
                              Our Development Approach
                                 ...
                                 <div className="d-flex flex-md-nowrap flex-wrap justify-content-between gap-xxl-15 gap-xl-10 gap-lg-7 gap-sm-5 gap-3 ">
                                <p className="pra-clr " style={{color:'#004f39 !important '}}>
                                  We created a high-resolution large-scale flex design optimized specifically for long-distance visibility and roadside impact. The branding elements were carefully structured to maintain strong visual hierarchy, ensuring that the logo, tagline, and contact details remain clear and readable even from a distance. Color selection and contrast were strategically designed to complement the internal LED lighting setup, allowing the board to maintain brightness, clarity, and premium appeal at night. Typography was selected to enhance readability under illuminated conditions, and spacing was balanced to avoid clutter while maintaining strong brand presence. The final artwork was delivered in print-ready, large-format resolution suitable for outdoor installation.
