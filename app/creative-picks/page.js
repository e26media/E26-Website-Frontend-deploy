...
export default function CreativePicks() {
                  ...
                  <div className="digital-solution mb-xxl-4 pb-lg-0 pb-15" style={{marginTop:'130px'}}>
                        <div className="mycustom-marque">
                            <div className="scrolling-wrap">
                                <div className="comm">
                                    <div className="cmn-textslide">Creative Picks</div>
                                     <div><img src="/assets/img/E26media/elements/text-slide.png" alt="img" /></div>
                                    <div className="cmn-textslide text-custom-storke">Creative Picks</div>
                                    <div><img src="/assets/img/E26media/elements/text-slide.png" alt="img" /></div>
                                </div>
                                <div className="comm">
                                     <div className="cmn-textslide">Creative Picks</div>
                    ...
                    <div className="container">
                        <div className="service-details-header bb-border pb-xxl-9 pb-xl-7 pb-6">
                            <div className="thumb w-100 mb-xxl-12 mb-xl-9 mb-sm-6 mb-5" data-aos="zoom-in" data-aos-duration={1500}>
                                <img src="/assets/img/E26media/ourworks/superstudy.webp" alt="Creative Design Studio" className="w-100"  style={{borderRadius:'20px'}}/>
                            </div>
                            ...
                            <div className="d-flex flex-wrap align-items-center gap-xxl-5 gap-xl-3 gap-2" data-aos="zoom-in-left" data-aos-duration={1800}>
                                <Link href="/creative-picks" className="radius-btn cmn-border radius100 py-xxl-2 py-2 px-xxl-4 px-3 theme-clr" style={{color:'#004f39'}}>
                                  Digital Artistry
                                </Link>
                                <Link href="/creative-picks" className="radius-btn cmn-border radius100 py-xxl-2 py-2 px-xxl-4 px-3 theme-clr" style={{color:'#004f39'}}>
                                  Motion Narrative
                        ...
                        <div className="case-study-detials-inner mt-xxl-10 mt-xl-7 mt-6">
                            ...
                            <div className="d-flex flex-md-nowrap flex-wrap justify-content-between gap-xxl-15 gap-xl-10 gap-lg-7 gap-sm-5 gap-3 mb-xxl-9 mb-xl-8 mb-lg-7 mb-4">
                                ...
                                We bring your brand's vision to life through stunning creative designs, compelling visuals, and engaging content. Our creative picks service combines artistic excellence with strategic thinking to deliver memorable brand experiences.
                                </p>
                                <p style={{color:'black'}}>
From graphic design to video editing, UI/UX to content creation, our team of creative experts crafts visually striking solutions that capture attention and communicate your message effectively across all platforms.
                                </p>
                            </div>
                            ...
                            <div className="d-flex align-items-center justify-content-between flex-wrap gap-5 mb-xxl-17 mb-xl-12 mb-lg-10 mb-md-10 mb-sm-10 mb-9">
                                <div className="pricing-title">
                                    ...
                                    <h2 className="stitle" style={{color:'#004f39'}}>
                                        Most <span className="fw-400" style={{color:'#004f39'}}>creative</span> design services
                                    </h2>
                                </div>
                            </div>
                                            ...
                                            <div className="accordion-btn justify-content-between d-flex align-items-center text-start d-flex position-relative w-100">
                                                <div className="mtitle-ara">
                                                    ...
                                                    <span className="mtitle d-block mt-6">
                                                        <Link href="/creative-picks" style={{color:'#004f39'}}>
                                                         Graphic Design
                                                        </Link>
                                                    </span>
                                                    <span className="pras mt-xxl-7 mt-xl-5 mt-4 d-block" style={{color:'#004f39'}}>
                                                      Eye-catching graphic designs that communicate your brand message effectively, from marketing collateral to social media visuals and print materials.
                                                    </span>
                                                </div>
                                                <div className="images-remove-area d-lg-flex d-none align-items-center gap-xxl-8 gap-4">
                                                    <ul className="modern-list d-grid gap-2">
                                                        <li className="d-flex align-items-center gap-2">
                                                            <i className="fas fa-chevron-right"  /> Marketing Collateral Design
                                                        </li>
                                                        <li className="d-flex align-items-center gap-2">
                                                            <i className="fas fa-chevron-right" /> Social Media Graphics
                                                        </li>
                                                        <li className="d-flex align-items-center gap-2">
                                                            <i className="fas fa-chevron-right" />Print & Digital Assets
                                                        </li>
                                                        <li className="d-flex align-items-center gap-2">
                                                            <i className="fas fa-chevron-right" />Illustration & Iconography
                                                        </li>
                                                    </ul>
                                                    <div className="tab-remove-thumb">
                                                        <img src="/assets/img/E26media/website/2.png" alt="Graphic Design" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="header-area" onClick={() => handleAccordion(2)}>
                                            <div className="accordion-btn justify-content-between d-flex align-items-center text-start d-flex position-relative w-100">
                                                <div className="mtitle-ara">
                                                    ...
                                                    <span className="pras mt-xxl-7 mt-xl-5 mt-4 d-block" style={{color:'#004f39'}}>
                                                     Comprehensive branding solutions that establish a strong, memorable identity for your business across all touchpoints.
                                                    </span>
                                                </div>
                                                <div className="images-remove-area d-lg-flex d-none align-items-center gap-xxl-8 gap-4">
                                                    <ul className="modern-list d-grid gap-2">
                                                        <li className="d-flex align-items-center gap-2">
                                                            <i className="fas fa-chevron-right" /> Logo & Brand Guide Creation
                                                        </li>
                                                        <li className="d-flex align-items-center gap-2">
                                                            <i className="fas fa-chevron-right" />Color Palette & Typography
                                                        </li>
                                                        <li className="d-flex align-items-center gap-2">
                                                            <i className="fas fa-chevron-right" />Brand Strategy Development
                                                        </li>
                                                        <li className="d-flex align-items-center gap-2">
                                                            <i className="fas fa-chevron-right" />Brand Asset Management
                                                        </li>
                                                    </ul>
                                                    <div className="tab-remove-thumb">
                                                        <img src="/assets/img/E26media/website/3.png" alt="Branding" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="header-area" onClick={() => handleAccordion(3)}>
                                            <div className="accordion-btn justify-content-between d-flex align-items-center text-start d-flex position-relative w-100">
                                                <div className="mtitle-ara">
                                                    ...
                                                    <span className="pras mt-xxl-7 mt-xl-5 mt-4 d-block" style={{color:'#004f39'}}>
                                                       Professional video editing services that transform raw footage into engaging stories, including social media reels and promotional content.
                                                    </span>
                                                </div>
                                                <div className="images-remove-area d-lg-flex d-none align-items-center gap-xxl-8 gap-4">
                                                    <ul className="modern-list d-grid gap-2">
                                                        <li className="d-flex align-items-center gap-2">
                                                            <i className="fas fa-chevron-right" /> Social Media Reels & Shorts
                                                        </li>
                                                        <li className="d-flex align-items-center gap-2">
                                                            <i className="fas fa-chevron-right" />Promotional Video Editing
                                                        </li>
                                                        <li className="d-flex align-items-center gap-2">
                                                            <i className="fas fa-chevron-right" />Motion Graphics & Effects
                                                        </li>
                                                        <li className="d-flex align-items-center gap-2">
                                                            <i className="fas fa-chevron-right" />Color Grading & Audio Mixing
                                                        </li>
                                                    </ul>
                                                    <div className="tab-remove-thumb">
                                                        <img src="/assets/img/E26media/website/2.png" alt="Video Editing" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="header-area" onClick={() => handleAccordion(4)}>
                                            <div className="accordion-btn justify-content-between d-flex align-items-center text-start d-flex position-relative w-100">
                                                <div className="mtitle-ara">
                                                    ...
                                                    <span className="pras mt-xxl-7 mt-xl-5 mt-4 d-block" style={{color:'#004f39'}}>
                                                      Intuitive and visually appealing user interfaces coupled with seamless user experiences for web and mobile applications.
                                                    </span>
                                                </div>
                                                <div className="images-remove-area d-lg-flex d-none align-items-center gap-xxl-8 gap-4">
                                                    <ul className="modern-list d-grid gap-2">
                                                        <li className="d-flex align-items-center gap-2">
                                                            <i className="fas fa-chevron-right" />Wireframing & Prototyping
                                                        </li>
                                                        <li className="d-flex align-items-center gap-2">
                                                            <i className="fas fa-chevron-right" />User Research & Testing
                                                        </li>
                                                        <li className="d-flex align-items-center gap-2">
                                                            <i className="fas fa-chevron-right" />Interactive Design Systems
                                                        </li>
                                                        <li className="d-flex align-items-center gap-2">
                                                            <i className="fas fa-chevron-right" />Mobile & Web App Design
                                                        </li>
                                                    </ul>
                                                    <div className="tab-remove-thumb">
                                                        <img src="/assets/img/E26media/website/3.png" alt="UI UX Design" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="header-area" onClick={() => handleAccordion(5)}>
                                            <div className="accordion-btn justify-content-between d-flex align-items-center text-start d-flex position-relative w-100">
                                                <div className="mtitle-ara">
                                                    ...
                                                    <span className="pras mt-xxl-7 mt-xl-5 mt-4 d-block" style={{color:'#004f39'}}>
                                                      Engaging and original content that tells your brand story, including copywriting, visual content, and multimedia storytelling.
                                                    </span>
                                                </div>
                                                <div className="images-remove-area d-lg-flex d-none align-items-center gap-xxl-8 gap-4">
                                                    <ul className="modern-list d-grid gap-2">
                                                        <li className="d-flex align-items-center gap-2">
                                                            <i className="fas fa-chevron-right" />Copywriting & Storytelling
                                                        </li>
                                                        <li className="d-flex align-items-center gap-2">
                                                            <i className="fas fa-chevron-right" />Visual Content Production
                                                        </li>
                                                        <li className="d-flex align-items-center gap-2">
                                                            <i className="fas fa-chevron-right" />Social Media Content Strategy
                                                        </li>
                                                        <li className="d-flex align-items-center gap-2">
                                                            <i className="fas fa-chevron-right" />Campaign Creative Development
                                                        </li>
                                                    </ul>
                                                    <div className="tab-remove-thumb">
                                                        <img src="/assets/img/E26media/website/3.png" alt="Content Creation" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <Swiper {...swiperOptions} className="swiper-wrapper">
                                <SwiperSlide>
                                    <div className="study-thumb-slide w-100">
                                        <img src="/assets/img/E26media/ourworks/superstudy.png" alt="Creative Portfolio" className="w-100"  style={{borderRadius:'10px'}}/>
                                    </div>
                                </SwiperSlide>
                                <SwiperSlide>
                                    <div className="study-thumb-slide w-100">
                                        <img src="/assets/img/E26media/ourworks/Al Mirath.webp" alt="Creative Work" className="w-100" style={{borderRadius:'10px'}} />
                                    </div>
                                </SwiperSlide>
                                <SwiperSlide>
                                    <div className="study-thumb-slide w-100">
                                        <img src="/assets/img/E26media/works/HEVN.png" alt="Design Showcase" className="w-100" style={{borderRadius:'10px'}}/>
                                    </div>
                                </SwiperSlide>
                                <SwiperSlide>
                                    <div className="study-thumb-slide w-100">
                                        <img src="/assets/img/E26media/ourworks/wafa.png" alt="Creative Success" className="w-100"  style={{borderRadius:'10px'}}/>
                                    </div>
                                </SwiperSlide>
