...
export default function Almirath() {
                        ...
                        <div className="case-study-detials-inner">
                            <div className="interesting-fact">
                                <h2 className="white-clr mb-6" >
                                 Al Mirath Real Estate – Digital Growth Strategy
                                </h2>
    ...
    Marketing Automation & Lead Nurturing
                            ...
                            <div className="d-flex flex-md-nowrap flex-wrap justify-content-between gap-xxl-15 gap-xl-10 gap-lg-7 gap-sm-5 gap-3 ">
                                <p className="pra-clr " style={{color:'#004f39 !important '}}>
                                  Al Mirath Real Estate operates in one of the most competitive real estate markets in the world. In Dubai, property buyers and investors rely heavily on Google searches to explore available listings, compare developers, and evaluate investment opportunities. The main objective of our SEO engagement was to position the brand prominently in search results, attract high-intent organic traffic, and establish long-term digital authority within the UAE property sector.
                            ...
                            <div className="row g-xxl-7 g-4 py-xxl-15 py-9">
                                ...
                                <div className="col-sm-6" >
                                 ...
                                 <div className="d-flex flex-md-nowrap flex-wrap justify-content-between gap-xxl-15 gap-xl-10 gap-lg-7 gap-sm-5 gap-3 ">
                                <p className="pra-clr " style={{color:'#004f39 !important '}}>
                                  Al Mirath Real Estate is a Dubai-based real estate company positioned for digital growth through a comprehensive strategy including Search Engine Optimization (SEO), social media marketing, Meta Ads, Google Ads, marketing automation, and conversion-focused landing pages. Our objective was to increase organic visibility in competitive Dubai property searches, generate qualified real estate leads, and strengthen brand authority among local and international investors. By combining technical SEO, high-intent paid advertising, and automated lead nurturing systems, we built a scalable digital marketing framework designed to drive consistent property inquiries and long-term growth in the UAE real estate market.
