...
export default function MeadowsRestoCafe() {
                    ...
                    <div className="container">
                        ...
                        <div className="case-study-detials-inner">
                            <div className="interesting-fact">
                               ...
                               Meadows Resto Cafe – Marketing Campaign
                                </h2>
  ...
  Social Media Management
                            ...
                            <div className="d-flex flex-md-nowrap flex-wrap justify-content-between gap-xxl-15 gap-xl-10 gap-lg-7 gap-sm-5 gap-3 ">
                                <p className="pra-clr " style={{color:'#004f39 !important '}}>
                                  Meadows Resto Cafe aimed to increase dine-in customers, promote special combos, and build strong local brand recognition in a competitive restaurant market. The primary objective of the Meta Ads campaign was to drive measurable footfall and boost overall sales through targeted digital advertising.
                            ...
                            <div className="row g-xxl-7 g-4 py-xxl-15 py-9">
                                ...
                                <div className="col-sm-6" >
                                 ...
                                 <div className="d-flex flex-md-nowrap flex-wrap justify-content-between gap-xxl-15 gap-xl-10 gap-lg-7 gap-sm-5 gap-3 ">
                                <p className="pra-clr " style={{color:'#004f39 !important '}}>
                                 Meadows Resto Cafe achieved significant growth through a comprehensive digital marketing strategy that included Meta Ads performance campaigns, promotional video production, graphic design creatives, and structured social media management. The objective was to increase dine-in footfall, promote special combo offers, and strengthen local brand recognition in a competitive restaurant market. By combining geo-targeted advertising, engaging food visuals, seasonal promotional campaigns, and consistent content strategy, we successfully improved customer engagement and contributed to nearly 3X sales growth.
