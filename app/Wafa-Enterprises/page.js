                                ...
                                <div className="case-content-box bg1-clr py-xxl-10 py-xl-9 py-lg-8 py-6 px-xxl-10 px-xl-8 px-lg-6 px-5">
                                    ...
                                    <ul className="case-infobox mb-xxl-12 mb-xl-10 mb-lg-8 mb-7">
                                        <li className="d-flex align-items-center justify-content-between gap-2">
                                            ...
                                            <span className="white-clr">
                                               Rewards & Loyalty <br/>Mobile Application
     ...
     Meta Ads
                            ...
                            <div className="d-flex flex-md-nowrap flex-wrap justify-content-between gap-xxl-15 gap-xl-10 gap-lg-7 gap-sm-5 gap-3 ">
                                <p className="pra-clr " style={{color:'#004f39 !important '}}>
                                   Wafa Scheme is a digital rewards and loyalty platform designed to connect businesses and customers through a structured earning and redemption system. The objective of the project was to build a simple yet scalable mobile application that enables users to earn points, track rewards, and redeem benefits seamlessly while maintaining clarity and transparency in the process.
...
<h4 className="mb-xxl-7 mb-4 white-clr mt-2">
                              Our Development Approach
                                 ...
                                 <div className="d-flex flex-md-nowrap flex-wrap justify-content-between gap-xxl-15 gap-xl-10 gap-lg-7 gap-sm-5 gap-3 ">
                                <p className="pra-clr " style={{color:'#004f39 !important '}}>
                                Wafa Scheme is a rewards and loyalty mobile application developed to connect businesses and customers through a structured point-earning and redemption system. The project included secure Android app development with scalable architecture, intuitive user experience design, and reliable reward tracking functionality. Alongside app development, Meta promotional campaigns were executed to strengthen brand awareness and highlight reward benefits among local audiences. By combining technology and targeted digital marketing, the project established a functional loyalty ecosystem that supports customer engagement, retention, and long-term growth.
