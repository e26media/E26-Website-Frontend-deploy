                                    ...
                                    <div className="about-samll-content">
                                        <div className="pricing-title">
                                           ...
                                           <p className="white-clr mb-xxl-8 mb-xl-8 mb-5" data-aos="zoom-in-up" data-aos-duration={1400}>
                                               E26 Media Pvt Ltd is a premium digital and technology agency focused on results, innovation, and long-term value. Led by <span style={{color:"#D1EA06",fontWeight:"bold"}}> Managing Director Shareef  </span> and<span style={{color:"#D1EA06",fontWeight:"bold"}}> CEO Mohammed Hazeem Shaim </span>, we help brands grow using a perfect blend of strategy, creativity, data, and AI-driven tools.
                                            </p>
                                            <p className="white-clr mb-xxl-8 mb-xl-8 mb-5" data-aos="zoom-in-up" data-aos-duration={1400}>
                                             We don’t believe in generic solutions. Every project is tailored, scalable, and performance-focused.
                                            </p>
                                             <p className="white-clr mb-xxl-8 mb-xl-8 mb-5" data-aos="zoom-in-up" data-aos-duration={1400}>
