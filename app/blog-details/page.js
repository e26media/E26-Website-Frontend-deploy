    ...
    return (
        <>
            ...
            <Layout headerStyle={2} footerStyle={2} breadcrumbTitle="Blog Details">
                <section className="blog-details pt-space pb-space" style={{backgroundColor:'white'}}>
                        ...
                        <div className="row g-5">
                            <div className="col-12 col-lg-8">
                                <div className="blog-post-details mb-xxl-10 mb-xl-8 mb-lg-7 mb-6">
                                    <div className="single-blog-post">
                                        <div className="post-featured-thumb w-100 mb-xxl-30 mb-xl-6 mb-5" data-aos="zoom-in" data-aos-duration={1400}>
                                            <img src="https://www.thezeroagency.in/dashboard/uploads/1752388194_bap_.jpg" alt="img" className="w-100" />
                                        </div>
                                        <div className="post-content">
                                            <div className="post-marry d-flex align-items-center gap-xxl-8 gap-xl-6 gap-4 gap-3 mb-xxl-5 mb-xl-4 mb-lg-3 mb-3" data-aos="fade-left" data-aos-duration={1500}>
                                                <span style={{color:'#004f39'}}>
                                                    Written by: Marry biden
                                                </span>
                                                <i className="fas fa-circle "  style={{color:'#004f39'}}/>
                                                <span style={{color:'#004f39'}}>
                                                    10/01/2024
                                                </span>
                                            </div>
                                            <div className="mb-xxl-13 mb-xl-10 mb-lg-8 mb-7">
                                                <h5 className="white mb-xxl-5 mb-3" data-aos="fade-left" data-aos-duration={1600}>
                                                    ...
                                                    their</h5>
                                                <p className="pra-clr mb-xxl-5 mb-3" data-aos="fade-left" data-aos-duration={1550} id='ptag'>
                                                ...
                                                <p className="pra-clr" data-aos="fade-left" data-aos-duration={1700} id='ptag'>
                                            ...
                                            <p className="pra-clr mb-xxl-8 mb-xl-6 mb-lg-5 mb-4" data-aos="zoom-in-left" data-aos-duration={1400} id='ptag'>
                                                Proin ultricies ultricies est vitae cursus. Nulla sit amet suscipit tortor.
                                                Maecenas dui erat, ornare eget tristique
                                            ...
                                            <ul className="blod-dlist d-grid gap-xl-2 gap-2 mb-xxl-8 mb-xl-6 mb-lg-5 mb-4" id='ptag'>
                                                <li>
                                            ...
                                            <p className="pra-clr" data-aos="zoom-in-left" data-aos-duration={1400} id='ptag'>
                                                Proin ultricies ultricies est vitae cursus. Nulla sit amet suscipit tortor.
                                                Maecenas dui erat, ornare eget tristique
                                                vitae, rutrum pretium justo. Phasellus vitae consequat nisi, quis luctus nisl.
                                                Praesent faucibus sem id massa semper
                                ...
                                <div className="tag-share d-sm-flex d-grid align-items-center justify-content-sm-between justify-content-center mb-xxl-8 mb-xl-7 mb-5 gap-3" data-aos="zoom-in" data-aos-duration={1400}>
                                    <div className="tag d-flex justify-content-sm-start justify-content-center align-items-center gap-xxl-4 gap-3" style={{color:'#004f39'}}>
                                        Tags:
                                    ...
                                    <div className="d-flex align-items-center justify-content-sm-start justify-content-center gap-xxl-4 gap-3" style={{color:'#004f39'}}>
                                        Share:
                                ...
                                <div className="row g-xl-7 g-4 mb-xxl-15 mb-xl-10 mb-8" >
                                    <div className="col-lg-6" data-aos="zoom-in" data-aos-duration={1400} >
                                        <div className="recent-items bg1-clr d-flex align-items-center gap-xxl-5 gap-xl-4 gap-lg-3 gap-2 py-xxl-6 py-xl-4 py-3 px-xxl-7 px-xl-5 px-lg-4 px-3" style={{backgroundColor:'#004f39'}}>
                            ...
                            <div className="col-12 col-lg-4" >
                                <div className="blog-right-bar mt-lg-0 mt-4" style={{background:'#004f39'}}>
